...
public class ReservationDTO {
	...
	public String toString() {
		return "ReservationDTO [reservation_num=" + reservation_num + ", reservation_payment_num="
				...
				+ ", reservation_product_name=" + reservation_product_name + ", reservation_price=" + reservation_price
				+ ", reservation_payment_date=" + reservation_payment_date + ", reservation_member_id="
				+ reservation_member_id + ", reservation_member_name=" + reservation_member_name
				+ ", reservation_member_phone=" + reservation_member_phone + ", reservation_payment_method="
				+ reservation_payment_method + ", reservation_payment_status=" + reservation_payment_status
