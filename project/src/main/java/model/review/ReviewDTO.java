...
public class ReviewDTO {
	...
	private int review_writer_level; // 리뷰 작성자 레벨
	...
	public int getReview_writer_level() {
		return review_writer_level;
	}

	public void setReview_writer_level(int review_writer_level) {
		this.review_writer_level = review_writer_level;
	}
